...
import ngoImage from "../../../assets/ngo-nongovernmental-organization-serve-specific-social-template-hand-drawn-illustration_2175-7898.avif";
import {
  createNgoAdminAsync,
...
const NGO_request = () => {
  ...
  useEffect(() => {
    dispatch(fetchNgoRequestAsync());
  }, []);
  const NGORequest = selectNGORequest;
  const ans = useSelector(selectNGORequest);
...
const RequestPage = ({ state, setState, num, ans }) => {
  const dispatch = useDispatch();
  const handleit = () => {
                  ...
                  <div className="text-gray-700">
                    <div className="grid md:grid-cols-2 text-sm">
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">{ans[num].contact}</div>
                      </div>
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">{ans[num].payment}</div>
                      </div>
                      <div className="grid grid-cols-2">
                        <div className="px-4 py-2 font-semibold">
                          Current Address
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">{ans[num].city}</div>
                      </div>

                      <div className="grid grid-cols-2">
                        <div className="px-4 py-2 font-semibold">State</div>
                        <div className="px-4 py-2">{ans[num].state}</div>
                      </div>
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">{ans[num].zip}</div>
                      </div>
                      <div className="grid grid-cols-2">
